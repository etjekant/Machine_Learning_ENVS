...
mode1 = data[:, "Mode"] 
mode1 = mode1[Other_method1 .!= "None"]
Reg_Best_method1 = Reg_Best_method1[Other_method1 .!= "None"]
...
mode1 = data[:, "Mode"] 
mode1 = mode1[Other_method1 .!= "None"]
Class_Best_method1 = Class_Best_method1[Other_method1 .!= "None"]
# Changing type of best_method in class
...
pyplt.savefig("best_models_filter.png")
